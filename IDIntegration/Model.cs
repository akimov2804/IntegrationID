    ...
    public class Model
    {
        ...
        */
        ...
        public void LoadCheckButtonData(CheckButton checkButton, PropertyControls propertyControls)
        {
            ...
            if (propertyControls.backgroundImage != null) checkButton.BackgroundImage = ByteToImage(Convert.FromBase64String(propertyControls.backgroundImage));
        ...
        public void LoadImageBoxData(UserImage userImage, PropertyControls propertyControls)
        {
            ...
            if (propertyControls.ImageOffValue != null) userImage.ImageOffValue = ByteToImage(Convert.FromBase64String(propertyControls.ImageOffValue));
            if (propertyControls.ImageOnValue != null) userImage.ImageOnValue = ByteToImage(Convert.FromBase64String(propertyControls.ImageOnValue));
            if (propertyControls.image != null) userImage.Image = ByteToImage(Convert.FromBase64String(propertyControls.image));
            userImage.ItemOfKernel = propertyControls.ItemOfKernel;
            if (propertyControls.First != null) userImage.Image1stOption = ByteToImage(Convert.FromBase64String(propertyControls.First));
            if (propertyControls.Second != null) userImage.Image2ndOption = ByteToImage(Convert.FromBase64String(propertyControls.Second));
            if (propertyControls.Third != null) userImage.Image3rdOption = ByteToImage(Convert.FromBase64String(propertyControls.Third));
            if (propertyControls.Fourth != null) userImage.Image4thOption = ByteToImage(Convert.FromBase64String(propertyControls.Fourth));
            if (propertyControls.Fifth != null) userImage.Image5thOption = ByteToImage(Convert.FromBase64String(propertyControls.Fifth));
